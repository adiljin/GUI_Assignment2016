...
import static GUI_Assignment.GUI_Forms.For_Customer.CU_CustomerMan.giveMeCU_CustomerMan;

/**
 * Created by adil on 28/11/16.
 */
public class CU_deleteCustomerShippers {
    ...
    public CU_deleteCustomerShippers() {
        cancelButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                giveMeDeleteCustomerShipper(false);
                giveMeCU_CustomerMan(true);
            }
        });
    ...
    public static void setFrameDeleteCustomerShipperVisible()
    {
        ...
        frameDeleteCustomerShipper.setContentPane(new CU_deleteCustomerShippers().panelDeleteShipping);
