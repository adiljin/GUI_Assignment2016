 ...
 */
public class CU_EditCustomerShipper {
    ...
    public static void setEditCustomerShipperVisible()
    {
        ...
        frameEditCustomerShipper.setContentPane(new CU_EditCustomerShipper().panelEditCustomerShipper);
