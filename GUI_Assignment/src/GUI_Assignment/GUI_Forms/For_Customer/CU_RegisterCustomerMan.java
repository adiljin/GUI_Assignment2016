 ...
 */
public class CU_RegisterCustomerMan {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if(dialogResult == JOptionPane.YES_OPTION)
                        {
                            ...
                            JOptionPane.showMessageDialog(panelRegisterCompany, "Information successfully saved!");
    ...
    public static void setCustomerManRegistrationVisible()
    {
        ...
        frameCustomerMan.setContentPane(new CU_RegisterCustomerMan().panelRegisterCompany);
