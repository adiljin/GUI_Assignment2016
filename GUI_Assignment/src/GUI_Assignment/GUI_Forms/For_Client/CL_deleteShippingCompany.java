...
import static GUI_Assignment.GUI_Forms.For_Client.CL_clientMan.giveMeCL_clientMan;

/**
 * Created by adil on 28/11/16.
 */
public class CL_deleteShippingCompany {
    ...
    public CL_deleteShippingCompany() {
        cancelButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                giveMeDeleteShippingCompany(false);
                giveMeCL_clientMan(true);
            }
        });
    ...
    public static void setFrameDeleteShipping()
    {
        ...
        frameDeleteShipping.setContentPane(new CL_deleteShippingCompany().panelDeleteShipping);
