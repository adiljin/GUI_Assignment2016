 ...
 */
public class CL_editShippingCompany {
    ...
    public CL_editShippingCompany() {
    cancelButton.addActionListener(new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent e) {
            giveMeEditShippingCompany(false);
            CL_clientMan.giveMeCL_clientMan(true);
        }
    });
    ...
    public static void setClientShippingCompany()
    {
        ...
        frameEditShipping.setContentPane(new CL_editShippingCompany().panelEditShipping);
