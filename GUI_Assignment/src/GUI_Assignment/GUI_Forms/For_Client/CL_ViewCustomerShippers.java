 ...
 */
public class CL_ViewCustomerShippers {
    ...
    public CL_ViewCustomerShippers() {
        cancelButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                giveMeViewCustomers(false);
                main_client_form.giveMeMainClientForm(true);
            }
        });
    ...
    public static void setViewCustomersVisible()
    {
        ...
        frameViewCustomers.setContentPane(new CL_ViewCustomerShippers().panelViewCustomers);
